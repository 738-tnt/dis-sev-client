...
public class Client extends javax.swing.JFrame {
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(layout.createSequentialGroup()
								.addComponent(tfChat, javax.swing.GroupLayout.PREFERRED_SIZE, 500,
						...
						.addGroup(layout.createSequentialGroup()
								...
								.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
										...
										.addComponent(tfSendTo, javax.swing.GroupLayout.DEFAULT_SIZE, 80,
												Short.MAX_VALUE))
	...
	private void b_connectActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (isConnected == false) {
			...
			try {
				...
				sock = new Socket(tfSendTo.getText(), port);
	...
	public static void main(String args[]) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			@Override
			// The run method, which will call the Client Constructor
			public void run() {
